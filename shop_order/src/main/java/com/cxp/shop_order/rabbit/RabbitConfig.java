...
//    public static final long EXPIRATION_LONG = 30 * 60 * 1000;
    public static final long EXPIRATION_LONG = 5  * 1000;
    public static final String EXPIRATION_STRING = "" + EXPIRATION_LONG;
