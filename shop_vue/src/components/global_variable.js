...
export default {
  ...
  ResultStatus: {
    ...
    USER_LOGIN_ERROR: 203,             //账号密码不对
    USER_ID_ERROR: 204,                //账号ID不存在
    USER_ID_LOGIN_OVERDUE: 205,        //用户过期或未登录
    USER_MONEY_INSUFFICIENT: 206,      //买家购物余额不足
    USER_MONEY_CHANGE_ERROE: 207,      //用户余额改变失败
